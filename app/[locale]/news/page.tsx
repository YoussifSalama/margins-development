...
export const metadata = { title: "News — Margins" };
...
export default async function News({
  ...
  return (
    <div>
      <PageHero
        title={t("heroTitleNews")}
        description={t("heroDescription")}
        current={t("heroTitleNews")}
        image={heroImage}
        overlayClassName="bg-hero-overlay-dark/70"
      />
      <PostsListing posts={posts} base="news" category={category} page={page} limit={limit} />
    </div>
  );
}
