  ...
  return (
    <section className="relative isolate flex min-h-[calc(100vh-96px)] items-center justify-center overflow-hidden bg-dark py-24 text-white">
      ...
      <div className="container flex flex-col items-center gap-6 text-center">
        <p className="font-heading text-[120px] leading-none tracking-[2px] text-accent sm:text-[160px]">
          {t("eyebrow")}
        </p>
        <h1 className="max-w-2xl font-heading text-[clamp(1.75rem,4vw+1rem,3rem)] leading-[1.15] tracking-[2px]">
          {t.rich("heading", { gold: (chunks) => <span className="text-accent">{chunks}</span> })}
        </h1>
